...
from .libros_views import show_books, book_detail, review_new, review_edit, review_publish, review_remove, review_detail, rate_review
...
urlpatterns = [
    ...
    path('rate_review/<int:pk>/', rate_review, name='rate_review'),
]